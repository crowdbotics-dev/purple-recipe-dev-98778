"""
Django settings for purple_recipe_dev_98778 project.
...
ROOT_URLCONF = 'purple_recipe_dev_98778.urls'
...
WSGI_APPLICATION = 'purple_recipe_dev_98778.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "purple_recipe_dev_98778 API",
    "DESCRIPTION": "API documentation for purple_recipe_dev_98778 App",
    "VERSION": "v1",
}
